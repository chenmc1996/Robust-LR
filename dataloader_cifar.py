...
class cifar_dataset(Dataset): 
    def __init__(self, dataset, r, noise_mode, root_dir, transform, mode, noise_file='',  probability=[], log=''): 
...
class cifar_dataloader():  
    ...
    def run(self,mode,prob=[]):
        if mode=='warmup':
            ...
            labeled_dataset = cifar_dataset(dataset=self.dataset, noise_mode=self.noise_mode, r=self.r, root_dir=self.root_dir, transform=TransformTwice(self.transform_train,self.strong_transform,), mode="labeled", noise_file=self.noise_file, probability=prob,log=self.log)
